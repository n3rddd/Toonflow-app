// @routes-hash 28255c1abae49ce4dc3f08e502620972
...
import route76 from "./routes/production/workbench/checkVideoStateList";
...
import route84 from "./routes/production/workbench/updateVideoPrompt";
import route85 from "./routes/project/addDirectorManual";
import route86 from "./routes/project/addProject";
import route87 from "./routes/project/addVisualManual";
import route88 from "./routes/project/deleteDirectorManual";
import route89 from "./routes/project/deleteVisualManual";
import route90 from "./routes/project/delProject";
import route91 from "./routes/project/editDirectorlManual";
import route92 from "./routes/project/editProject";
import route93 from "./routes/project/editVisualManual";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/workbench/checkVideoStateList", route76);
  ...
  app.use("/api/production/workbench/updateVideoPrompt", route84);
  app.use("/api/project/addDirectorManual", route85);
  app.use("/api/project/addProject", route86);
  app.use("/api/project/addVisualManual", route87);
  app.use("/api/project/deleteDirectorManual", route88);
  app.use("/api/project/deleteVisualManual", route89);
  app.use("/api/project/delProject", route90);
  app.use("/api/project/editDirectorlManual", route91);
  app.use("/api/project/editProject", route92);
  app.use("/api/project/editVisualManual", route93);
